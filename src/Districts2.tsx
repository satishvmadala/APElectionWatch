...
const DefaultObservers = ({districtId, clsName})=> {


  return <div className={clsName}> <div className={districtId.length >0 ? 'd-none': 'd-block'}>
...
const DefaultMembersContainer = ({districtId}) =>{
    
    
  return <div className={districtId?.length >0 ? 'd-none': 'd-block' }><div className="table-responsive-sm">
...
const Assembly = () => {
  ...
  const RightContainer = ()=>{
    ...
    {districtId && 
            ...
            <>
            <div>
          <span className="h3">{districtName} District</span><br></br>
  ...
  const mapClick = ( districtId: string, districtName: string) =>{

   // setconstituencyId(null);
    setDistrictId(districtId);
    setDistrictName(districtName);
   // setloksabhaName(loksabhaName)
  }
        ...
        <div className='side-cont-div'>
          ...
          <DistrictFilter mapClick={mapClick} />
            ...
            <Row>
              ...
              <DefaultObservers districtId={districtId} clsName={'d-none d-lg-block'}/>
              <MapBottomContainer clsName={'d-none d-lg-block'}/>
              </Col>
              <Col lg="6" md="12" className="table-responsive-sm">
                <DefaultMembersContainer districtId={districtId}/>
              <RightContainer />
              </Col>
            </Row>
            <Row>
            <Col lg="6" md="12">
            <DefaultObservers districtId={districtId} clsName={' d-lg-none'}/>
